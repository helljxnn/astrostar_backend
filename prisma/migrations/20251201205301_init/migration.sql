...
-- CreateIndex
CREATE INDEX "employee_schedules_scheduleDate_idx" ON "employee_schedules"("scheduleDate");

-- CreateIndex
CREATE INDEX "employee_schedules_status_idx" ON "employee_schedules"("status");
...
-- CreateIndex
CREATE UNIQUE INDEX "inscriptions_athleteId_sportsCategoryId_key" ON "inscriptions"("athleteId", "sportsCategoryId");
...
-- AddForeignKey
ALTER TABLE "ServiceCategory" ADD CONSTRAINT "ServiceCategory_categoryId_fkey" FOREIGN KEY ("categoryId") REFERENCES "sports_categories"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
