...
export const sportsCategoryValidators = {
  ...
  create: [
    ...
    body('minAge').notEmpty().withMessage('La edad mínima es obligatoria.').isInt({ min: 4, max: 79 }).withMessage('La edad mínima debe estar entre 4 y 79 años.').toInt(),
    body('maxAge').notEmpty().withMessage('La edad máxima es obligatoria.').isInt({ min: 5, max: 80 }).withMessage('La edad máxima debe estar entre 5 y 80 años.')
      .custom((value, { req }) => {
  ...
  update: [
    ...
    body('minAge').optional().isInt({ min: 4, max: 79 }).withMessage('La edad mínima debe estar entre 4 y 79 años.').toInt(),
    body('maxAge').optional().isInt({ min: 5, max: 80 }).withMessage('La edad máxima debe estar entre 5 y 80 años.')
      .custom((value, { req }) => {
